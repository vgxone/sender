...
echo "\e[1;91m           ║    \e[1;91m      CLAY SENDER V.1.3 - HOTMAIL KILLER      \e[1;91m    ║   \e[0m\r\n";
...
echo "\e[1;91m           ║~ \e[1;92mFacebook : \e[1;91mhttps://www.facebook.com/vidz.sianipar\e[1;91m   ║\e[0m\r\n";
echo "\e[1;91m           ║~ \e[1;92mWhatsapp : \e[1;91m+6282370721424\e[1;91m                           ║\e[0m\r\n";
echo "\e[1;91m           ╚══════════════════════════════════════════════════════╝\e[1;91m\r\n";
echo "\e[1;91m              \r\n";
echo "\r\n";
...
function Kirim($email, $smtp_acc, $gx_setup)
{
    $smtp           = new SMTP;
    $smtp->do_debug = 0;
	$from = Array('Canada Post','CanadaPost','Support');
	$fromm = $from[array_rand($from)];
    ...
    $fromname       = $fromm;
    $frommail       = $smtp_acc['frommail'];
    $subject        = $gx_setup['subject']. rand(111111, 9999999);
    ...
    if (array_key_exists('AUTH', $e)) {
        ...
        if ($smtp->authenticate($smtpuser, $smtppass)) {
            ...
            $subjects  = str_replace('##randstring##', $asu2, $subject). rand(111111, 9999999);
